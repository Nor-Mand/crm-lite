...
custom_field = "appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-1 px-4 mt-2 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
